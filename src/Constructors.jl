...
@with_kw mutable struct GameHistory
	...
	reanalysed_predicted_root_values::Union{Vector{Float32}, Nothing} = nothing
	priorities::Union{Vector{Float32}, Nothing} = nothing
	game_priority::Union{Float32, Nothing} = nothing
end
...
@with_kw struct Config
	...
	PER_alpha::Float32 = 1.0 # How much prioritization is used, 0 corresponding to the uniform case, paper suggests 1
...
@with_kw mutable struct ResNetHP
	...
	representation_output_size::Any
	depth_policy::Int
	depth_value::Int
end
